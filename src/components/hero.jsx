    ...
    <div className="m-auto mt-5 w-4/6 flex justify-between">
      <div className="flex flex-col w-1/2">
        <div className="flex flex-row items-center">
          ...
          <span className="ml-[8px] text-[#4338CA] text-xl">
            {data.personal.name}
          </span>
        </div>
        <div className="text-7xl font-bold py-[40px] text-[#1F2937]">
          {data.personal.title}
        </div>
        ...
        <div className="flex flex-row gap-3 mt-5">
          <a
            ...
            className="flex flex-row items-center bg-[#4338CA] px-8 py-3.5 text-white rounded-md font-medium"
          >
            {data.navCta.label}
          </a>
          ...
          <a
            ...
            className="flex flex-row items-center text-[#4338CA] pr-6 border-1 rounded-md font-medium gap-1"
          >
